...
function SortCharactersByNameDescending() {
  ...
  useEffect(() => {
    ...
    var apiUrl = `https://lumen-ice-and-fire-muoki.herokuapp.com/api/characters?sort_by_name=desc`;
    fetch(apiUrl)
      .then((res) => res.json())
      .then((characters) => {
...
export default SortCharactersByNameDescending;
