...
function SortCharactersByGenderAscending() {
  ...
  useEffect(() => {
    ...
    var apiUrl = `https://lumen-ice-and-fire-muoki.herokuapp.com/api/characters?sort_by_gender=asc`;
    fetch(apiUrl)
      .then((res) => res.json())
      .then((characters) => {
...
export default SortCharactersByGenderAscending;
