...
function SortCharactersByAgeAscending() {
  ...
  useEffect(() => {
    ...
    var apiUrl = `https://lumen-ice-and-fire-muoki.herokuapp.com/api/characters?sort_by_age=asc`;
    fetch(apiUrl)
      .then((res) => res.json())
      .then((characters) => {
...
export default SortCharactersByAgeAscending;
